...
if(!file_exists('config.json')){
	$token = readline('HI 𝑨𝑳𝑺𝑬𝑨𝑫𝑨 ENTER TOKEN: ');
	$id = readline('HI 𝑨𝑳𝑺𝑬𝑨𝑫𝑨 ENTER ID: ');
      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/sjdjwjnsnzn/3",
                   'caption'=>'تمت البرمجه بواسطه { السياده } ⚜️ @KK77KK7 🛡️',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'إضافة حساب وهمي جديد ☠️🛠️','callback_data'=>'login']],
                      ]
                  ])
              ]);   
             
             $bot->sendvideo([ 'chat_id'=>$chatId,
                  'video'=>"https://t.me/ttemtim",
...
تمت البرمجه بواسطه { السياده } ⚜️ @KK77KK7  🛡️ ",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
					...
					$bot->sendphoto([
							'chat_id'=>$chatId,
							'photo'=> "https://t.me/sjdjwjnsnzn/2",
							 'caption'=>'الالبوت مدفوع 💲 و ليس مجاني🛡️☠️
لشراء النسخه راسل المطور ☣️⚜️',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'🛡️| 『 { السياده }  』','url'=>'t.me/KK77KK7']],
                          [['text'=>"🛡️| اشترك قناه المطور", 'url'=>"https://t.me/QQQVQQQQ"]],
                      ]
                  ])
              ]);   
				}
